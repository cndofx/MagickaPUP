...
namespace MagickaPUP.MagickaClasses.Liquids
{
    public class Lava : Liquid
    {
        ...
        public bool flag { get; set; } // this flag determines whether it kills entities or not when they contact the lava.
        ...
        public override void ReadInstance(MBinaryReader reader, DebugLogger logger = null)
        {
            ...
            logger?.Log(2, $" - Kills Entities : {this.flag}");
            logger?.Log(2, $" - Is Freezable   : {this.freezable}");
            logger?.Log(2, $" - Auto Freeze    : {this.autofreeze}");
        }

        public static new Lava Read(MBinaryReader reader, DebugLogger logger = null)
        {
            var ans = new Lava();
