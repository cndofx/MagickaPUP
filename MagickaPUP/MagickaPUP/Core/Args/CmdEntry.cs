...
namespace MagickaPUP.Core.Args
{
    ...
    public struct CmdEntry
    {
        ...
        public CmdFunction fn; // Function that is executed when running the command

        public CmdEntry(string cmd1, string cmd2, string desc1, string desc2, int args, CmdFunction fn)
        {
            this.cmd1 = cmd1;
            this.cmd2 = cmd2;
            this.desc1 = desc1;
